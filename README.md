...
A lightweight v1.0.0 (12mb) - v3.0.0 (60mb), native macOS file manager powered by Ollama. Browse, search, and manage your files with the help of AI-backed  insights and tagging — all in a simple, fast, and offline-first desktop app.
